...
public class QueueImplTest {
	...
	private QueueImpl<Student> studentLine;

	@Before
	public void setUp() throws Exception {
		studentLine = new QueueImpl<Student>();
	}
	...
	/**
	 * size should be 3 when inserted 3 elements
	 */
	@Test
	public void sizeShouldBe3WhenInserted3Elements() {
		studentLine.enqueue(new Student("leela", "thati"));
		studentLine.enqueue(new Student("sahiti", "thati"));
		studentLine.enqueue(new Student("virat", "k"));
		assertEquals(3, studentLine.size());
		}
